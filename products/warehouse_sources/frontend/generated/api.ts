...
import type {
    ...
    ExternalDataSchemasDestinationsPartialUpdateParams,
...
export const getExternalDataSchemasDestinationsRetrieveUrl = (
    projectId: string,
    id: string,
    ...
    return stringifiedParams.length > 0
        ? `/api/projects/${projectId}/external_data_schemas/${id}/destinations/?${stringifiedParams}`
        : `/api/projects/${projectId}/external_data_schemas/${id}/destinations/`
}
...
export const getExternalDataSchemasDestinationsPartialUpdateUrl = (
    projectId: string,
    id: string,
...
export const getExternalDataSchemasLogsRetrieveUrl = (projectId: string, id: string) => {
    return `/api/projects/${projectId}/external_data_schemas/${id}/logs/`
}
...
export const externalDataSchemasLogsRetrieve = async (
    ...
    return apiMutator<void>(getExternalDataSchemasLogsRetrieveUrl(projectId, id), {
        ...options,
        method: 'GET',
    })
}
