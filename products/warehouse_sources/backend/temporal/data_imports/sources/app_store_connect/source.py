...
Sales and subscription reports also need your vendor number (App Store Connect → **Payments and Financial Reports**) and a key with the Finance, Sales, or Admin role. Leave it blank if you only want app, review and build data."""
    ...
    def get_non_retryable_errors(self) -> dict[str, str | None]:
        ...
        return {
            ...
            "App Store Connect rejected a report request as invalid (HTTP 400)": "App Store Connect rejected this report request. The report type or version it asks for may no longer be valid. This usually needs a source update — contact support if it keeps failing.",
        }
