...
GOOGLE_TAG_MANAGER_APP_CLIENT_ID = get_from_env("GOOGLE_TAG_MANAGER_APP_CLIENT_ID", "")
GOOGLE_TAG_MANAGER_APP_CLIENT_SECRET = get_from_env("GOOGLE_TAG_MANAGER_APP_CLIENT_SECRET", "")
