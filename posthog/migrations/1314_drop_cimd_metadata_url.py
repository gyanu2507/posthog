...
class Migration(migrations.Migration):
    ...
    1313 removed the field from Django state, so this is the database half of that drop and
    carries no state operation. Land it only once 1313 has been deployed for a full deploy
    ...
    dependencies = [("posthog", "1313_untrack_cimd_metadata_url")]
